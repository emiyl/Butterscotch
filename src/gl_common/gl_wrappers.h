#if !defined(_BS_GL_WRAPPERS_H_) && !defined(__EMSCRIPTEN__) &&                \
    !defined(PLATFORM_PS3) && !defined(__ANDROID__) && !defined(PLATFORM_IOS)
...
static inline void rt_glFramebufferTexture2D(GLenum target, GLenum attachment,
...
static inline void rt_glBlitFramebuffer(GLint srcX0, GLint srcY0, GLint srcX1,
